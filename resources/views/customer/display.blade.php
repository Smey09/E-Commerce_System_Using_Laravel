            ...
            <div class="col-sm-auto bg-light sticky-top">
                ...
                <div class="d-flex flex-sm-column flex-row flex-nowrap bg-light align-items-center sticky-top">
                    <ul
                        ...
                        <li>
                            <a href="/product" class="nav-link py-3 px-2" title="" customer-bs-toggle="tooltip"
                                customer-bs-placement="right" customer-bs-original-title="Products">
                                <i class="bi-heart fs-1">

                                    <button type="button" class="btn btn-primary"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-customerbase-fill-add"
                                            viewBox="0 0 16 16">
                                            <path
                        ...
                        <li>
                            <a href="#" class="nav-link py-3 px-2" title="" customer-bs-toggle="tooltip"
                                customer-bs-placement="right" customer-bs-original-title="Customers">
                    ...
                    <div class="dropdown">
                        <a href="/st"
                            ...
                            id="dropdownUser3" customer-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr class="bg-primary">
                                    ...
                                    <td>{{ $customer->Cus_Order_model }}</td>
                                    <td>{{ $customer->Cus_Order_price }}</td>
                                    <td>{{ $customer->Cus_Order_date }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
