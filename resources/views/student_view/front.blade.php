            ...
            <div class="col-sm p-3 min-vh-100">
                <! -- Body page -->
                                    ...
                                    <td>
                                        <div class="col">
                                            <form action="{{ route('st.destroy', $x->sId) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <a href="{{ route('st.show', $x->sId) }}"
                                                    class="btn btn-info btn-sm">Viwie</a>
                                                <a href="{{ route('st.edit', $x->sId) }}"
                    ...
                    <div>
                        ...
                        <a href="/st"><button type="button" class="btn btn-danger">1</button></a>
                        <a href="/major"><button type="button" class="btn btn-primary">2</button></a>
                        <a href="/cus"><button type="button" class="btn btn-primary">3</button></a>
