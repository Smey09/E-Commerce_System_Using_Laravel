            ...
            <div class="col-sm p-3 min-vh-100">
                ...
                <! -- Body page -->
                        ...
                        <tbody>
                            @foreach ($customer as $x)
                                <tr>
                                    ...
                                    <td>{{ $x->Cus_Tel }}</td>
                                    <td>{{ $x->Cus_Gender }}</td>
                                    <td>{{ $x->Cus_Order_model }}</td>
                                    <td>{{ $x->Cus_Order_price }}</td>
                                    <td>{{ $x->Cus_Order_date }}</td>
                                    <td>
                                        <div>
                                            <a href="{{ route('customer.show', $x->Cus_Id) }}"
                                                class="btn btn-info btn-sm">Viwie</a>
                                            <a href="{{ route('customer.edit', $x->Cus_Id) }}"
                    ...
                    <div>
                        ...
                        {{-- <a href="{{ route('customer.create') }}"><button type="button" class="btn btn-danger">Add
                                New</button></a> --}}
                    </div>
                    <! -- Body page -->
            </div>
