                        ...
                        <div class="card">
                            <div class="container">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <div class="card">
                                            <img src="{{ $data->pro_images }}" class="card-img-top"
                                                alt="Problem with url images ! (This Model Don't have image display)">
                                            <div class="container text-center">
                                                <div class="card-body">
                                                    <h5 class="card-title">{{ $data->pro_name }}<p></p><a
                                                            href="#"
                                                            class="btn btn-warning">{{ $data->pro_price }}</a></h5>
                                                    <p class="card-text">{{ $data->pro_type }}</p>
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <div class="container text-center">
                                                <h4>Detail About {{ $data->pro_name }}</h4>
                                            </div>
