                            ...
                            <form action="{{ route('st.update', $item->sId) }}" method="post">
                                            ...
                                            <tr>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="sName"
                                                        id="sName" aria-describedby="helpId"
                                                        placeholder="Enter Name" value="{{ $item->sName }}" />
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="tel"
                                                        ...
                                                        placeholder="Enter Tel" value="{{ $item->tel }}" />
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="gender"
                                                        id="gender" aria-describedby="helpId"
                                                        placeholder="Enter Gender" value="{{ $item->gender }}" />
                                                </div>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div>
                                    <button type="submit" class="btn btn-primary"><a
                                            href="{{ route('st.index') }}"></a>UPDATE</button>
                                    <a name="" id="" class="btn btn-primary"
                                        href="{{ route('st.index') }}" role="button">BACK</a>
                                </div>
                            </form>
                        </div>
                    </div>
